...
<body>
    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $height = floatval($_POST['height']) / 100; // แปลงส่วนสูงเป็นเมตร
            ...
            if ($weight > 0 && $height > 0) {
                ...
                echo "<p><strong>น้ำหนัก:</strong> {$_POST['weight']} กิโลกรัม</p>";
                echo "<p><strong>ส่วนสูง:</strong> {$_POST['height']} เซนติเมตร</p>";
                echo "<p><strong>BMI ของคุณคือ:</strong> $bmi</p>";

                // คำแนะนำตามค่า BMI
                if ($bmi < 18.5) {
                    echo "<p>คุณมีน้ำหนักน้อยเกินไป</p>";
                } elseif ($bmi >= 18.5 && $bmi < 25.0) {
                    echo "<p>คุณมีน้ำหนักปกติ</p>";
                } elseif ($bmi >= 25.0 && $bmi < 30.0) {
                    echo "<p>คุณเริ่มอ้วน</p>";
                } elseif ($bmi >= 30.0 && $bmi < 35.0) {
                    echo "<p>คุณอ้วน</p>";
                } else {
                    echo "<p>คุณอ้วนมากผิดปกติ</p>";
                }
                echo "</div>";
            } else {
